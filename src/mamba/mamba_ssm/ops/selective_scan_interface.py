...
def selective_scan_ref(u, delta, A, B, C, D=None, z=None, delta_bias=None, delta_softplus=False,
    ...
    if A.is_complex():
        ...
        B = B.float()
        C = C.float()
    x = A.new_zeros((batch, dim, dstate)) if init_state is None else init_state[None].repeat(batch, 1, 1)
    ys = []
...
def selective_scan_naiv(u, delta, A, B, C, D=None, z=None, delta_bias=None, delta_softplus=False,
                      return_last_state=False):
    """
    u: r(B D L)
    delta: r(B D L)
